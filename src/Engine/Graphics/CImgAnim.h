...
/*!
*	\class ImgAnim
*	\brief  Comme Anim à la diférence près que la classe utilise une image avec tout les sprites
*	        au lieu des couches d'une layer.
*/
class CImgAnim :
	public CAnim, public sf::Sprite
{
public:
	/*!
	...
	*/
	CImgAnim(const sf::Image &Img, const unsigned int &nbFrame, const unsigned int &line=1, const unsigned int &maxLine=1,
